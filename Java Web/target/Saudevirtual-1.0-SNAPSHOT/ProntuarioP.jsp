                    ...
                    <div class="col">
                        <form action="ServPronto" method="Post">
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col"><label class="col-form-label" style="font-weight: bold;">História da doença atual:<br></label></div>
                                </div>
                                <div class="form-row">
                                    <div class="col"><textarea class="form-control" name="historicodoca" rows="5"></textarea></div>
                                </div>
                                <div class="form-row">
                                    <div class="col"><label class="col-form-label" style="font-weight: bold;">Anotações:&nbsp;<br></label></div>
                                </div>
                                <div class="form-row">
