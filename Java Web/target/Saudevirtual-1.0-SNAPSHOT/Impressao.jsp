    ...
    <body style="background: url(&quot;assets/img/padrao-sem-emenda-colorido-pastel-para-cuidados-dentarios_1284-44406.jpg&quot;);">
        ...
        <section class="border rounded border-dark shadow-lg features-boxed" style="color: var(--gray-dark);margin-left: 30px;margin-right: 30px;margin-top: 10px;margin-bottom: 10px;">
            <div class="container" style="color: var(--gray-dark);">
                <div class="intro">
                    <h2 class="text-center">Documentos para impressão</h2>
                </div>
                <div class="row justify-content-center features">
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="border rounded box"><i class="fa fa-list-alt icon" style="color: rgb(33,132,248);"></i><a class="learn-more" href="ImpQuestoesSaude.jsp" style="width: 210px;height: 21px;margin: 0px 0px 8px;color: var(--gray-dark);font-size: 18px;"><br><strong>QUESTIONÁRIO DE SAÚDE</strong><br></a></div>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="border rounded box"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-mood-kid icon" style="color: rgb(33,132,248);">
                            ...
                            </svg><a class="learn-more" href="ImpQuestoesInfantil.jsp" style="width: 210px;height: 21px;margin: 0px 0px 8px;color: var(--gray-dark);font-size: 18px;"><br><strong>QUESTIONÁRIO INFANTIL</strong><br></a></div>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="border rounded box"><i class="fa fa-list-alt icon" style="color: rgb(33,132,248);"></i><a class="learn-more" href="ImpExameFisico.jsp" style="width: 210px;height: 21px;margin: 0px 0px 8px;color: var(--gray-dark);font-size: 18px;"><br><strong>EXAME FÍSICO</strong><br></a></div>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="border rounded box"><i class="fa fa-user-md icon" style="color: rgb(33,132,248);"></i><a class="learn-more" href="prontuarioC.jsp" style="width: 210px;height: 21px;margin: 0px 0px 8px;color: var(--gray-dark);font-size: 18px;"><br><strong>PRONTUÁRIO</strong><br></a></div>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
