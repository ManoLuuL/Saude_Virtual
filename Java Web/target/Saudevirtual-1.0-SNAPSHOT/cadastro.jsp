        ...
        <section class="register-photo" style="background: url(&quot;assets/img/padrao-sem-emenda-colorido-pastel-para-cuidados-dentarios_1284-44406.jpg&quot;);">
            <div class="form-container">
                <form action="InserirUsuario.jsp" method="POST" style="background: rgb(255, 255, 255);">
                    <h2 class="text-center"><strong>Cadastre o&nbsp;Usuário</strong></h2>
                    ...
                    <div class="form-group">
                        <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="checkbox" name="termos" required="">Eu aceito os termos de licença.</label></div>
                    </div>
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Cadastrar</button></div><a class="already" href="login.html">Já possui uma conta? Faça seu Login.</a>
                </form>
            </div>
        </section>
