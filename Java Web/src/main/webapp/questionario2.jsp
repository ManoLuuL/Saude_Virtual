                    ...
                    <form action="ServQuest2" method="post">
                        <div class="form-group">
                            <div class="form-row" style="padding: 3px;">
                                <div class="col"><label class="col-form-label"><strong>3.2)&nbsp;Questionário complementar infantil - ODONTOPEDIATRIA</strong><br></label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col"><label>1- História da gestação:</label>
                            ...
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8PX;"><input class="form-check-input" type="checkbox" id="formCheck-2" name="parto" value="A FÓRCEPS">
                                        <label class="form-check-label" for="formCheck-2">A fórceps</label></div>
                            ...
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col-md-6"><label class="col-form-label">3-&nbsp;A criança teve algum problema no parto?</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-5" name="prob" value="NÃO">
                                        <label class="form-check-label" for="formCheck-5">NÃO</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col-md-2"><label class="col-form-label">4-&nbsp;A amamentação foi:</label></div>
                                <div class="col-md-2">
                            ...
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col"><label class="col-form-label">até a idade de:&nbsp;</label></div>
                                <div class="col-md-10"><input class="form-control form-control-sm" type="text" name="idadeamame" style="width: 250px;"></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col"><label class="col-form-label">5-&nbsp;Já lhe foi dito para não tomar anestesia local?</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-9" name="anes" value="NÃO">
                                        <label class="form-check-label" for="formCheck-9">NÃO</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col"><label class="col-form-label">6- Já teve ou viveu com alguém que tivesse doença grave e contagiosa?</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-11" name="grave" value="NÃO">
                                        <label class="form-check-label" for="formCheck-11">NÃO</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col"><label class="col-form-label">7-&nbsp;A criança já foi vacinada?</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;padding-left: 18px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8PX;"><input class="form-check-input" type="checkbox" id="formCheck-13" name="vac" value="NÃO">
                                        <label class="form-check-label" for="formCheck-13">NÃO</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col offset-md-0 text-center"><label class="col-form-label"><strong>CONDUTA DA CRIANÇA</strong></label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                            ...
                            <div class="form-row" style="padding: 3px;">
                                <div class="col">
                                    ...
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-56" name="aprend" value="NÃO">
                                        <label class="form-check-label" for="formCheck-19">NÃO</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col"><label class="col-form-label">Estado anímico:</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-59" name="estadoa" value="TIMIDO">
                                        <label class="form-check-label" for="formCheck-20">Tímido</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col">
                            ...
                            <div class="form-row" style="padding: 3px;">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-67" name="sono" value="INSONIA">
                                        <label class="form-check-label" for="formCheck-26">Insônia</label></div>
                                </div>
                                <div class="col">
                            ...
                            <div class="form-row" style="padding: 3px;">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-71" name="conduta" value="FONAÇÃO NORMAL">
                                        <label class="form-check-label" for="formCheck-32">Fonação normal</label></div>
                                </div>
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-72" name="conduta" value="DISTÚRBIOS DA FALA">
                                        <label class="form-check-label" for="formCheck-32">Distúrbios da fala</label></div>
                                </div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-75" name="conduta" value="DESCONTROLE DOS ESFÍNCTERES">
                                        <label class="form-check-label" for="formCheck-32">Descontrole dos esfíncteres</label></div>
                                </div>
                                <div class="col"></div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col"><label class="col-form-label">Alimentação:</label></div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                                <div class="col-md-2">
                            ...
                            <div class="form-row" style="padding: 3px;">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-81" name="relacao" value="RELAÇÕES NORMAIS">
                                        <label class="form-check-label" for="formCheck-42">Relações normais</label></div>
                                </div>
                                <div class="col"></div>
                            </div>
                            <div class="form-row" style="padding: 3px;">
                            ...
                            <div class="form-row" style="padding: 3px;">
                                ...
                                <div class="col">
                                    <div class="form-check" style="margin: 8px;"><input class="form-check-input" type="checkbox" id="formCheck-87" name="patologia" value="CIÚMES">
                                        <label class="form-check-label" for="formCheck-45">Ciúmes</label></div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col"><label>Observações:</label><textarea class="form-control form-control-sm" name="obs" rows="4"></textarea></div>
                            </div>
