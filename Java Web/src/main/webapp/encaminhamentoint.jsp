    ...
    <body style="background: url(&quot;assets/img/padrao-sem-emenda-colorido-pastel-para-cuidados-dentarios_1284-44406.jpg&quot;);">
        ...
        <section class="border rounded border-dark shadow-lg" style="background: #ffffff;margin: 10px 30px;margin-left: 30px;margin-right: 30px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <form action="ServInt" method="Post">
                            <div class="form-group">
                                <div class="form-row" style="padding: 3px;">
                                    <div class="col"><label>Paciente:&nbsp;</label><input class="form-control form-control-sm" type="text" name="paciente" placeholder="Nome do Paciente" style="width: 250px;"></div>
                                    <div class="col"><label>Prontuário:&nbsp;</label><input class="form-control form-control-sm" type="text" name="prontuario" placeholder="Numero do Prontuario" style="width: 250px;"></div>
                                </div>
                                <div class="form-row" style="padding: 3px;">
