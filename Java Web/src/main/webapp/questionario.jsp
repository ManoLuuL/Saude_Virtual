    ...
    <body style="transform: translate(0px);background: url(&quot;assets/img/padrao-sem-emenda-colorido-pastel-para-cuidados-dentarios_1284-44406.jpg&quot;), #ffffff;">
        ...
        <section class="border rounded border-dark shadow-lg" style="background: rgb(255,255,255);margin: 10px 30px;margin-left: 30px;margin-right: 30px;">
            <div class="container" style="padding: 9px;">
                <h1 class="border rounded" style="text-align: center;font-size: 30px;padding: 16px;background: rgba(152,149,150,0.2);">QUESTIONÁRIO DE SAÚDE:<br>CRIANÇA E ADULTO<br></h1>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <form action="ServQuest1" method="post">
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col"><label class="col-form-label" style="font-weight: bold;">2) História da doença atual:<br></label></div>
                                </div>
                                <div class="form-row">
                                    <div class="col"><textarea class="form-control" name="historicodoca" rows="5"></textarea></div>
                                </div>
                                <div class="form-row">
                                    <div class="col"><label class="col-form-label" style="font-weight: bold;">3.1) Questionário de Saúde<br></label></div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col-md-12 offset-md-0"><label>1-&nbsp;Já teve hemorragia?<br></label>
                                        ...
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-42" name="hemor" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>2-&nbsp;Sofre(u) de alergia?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-43" name="alergia" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-44" name="alergia" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>3- Teve reumatismo infeccioso?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-45" name="infec" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-46" name="infec" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>4-&nbsp;Sofre(u) de distúrbio cardiovascular?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-47" name="cardio" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-48" name="cardio" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>5-&nbsp;Sofre(u) de gastrite?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-49" name="gast" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-50" name="gast" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>6-&nbsp;&nbsp;É diabético ou tem familiares diabéticos?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-51" name="diab" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-52" name="diab" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>7-&nbsp;&nbsp;Já desmaiou alguma vez?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-53" name="desm" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-54" name="desm" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>8-&nbsp;&nbsp;Está sob tratamento médico?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-55" name="trat" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-56" name="trat" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>9-&nbsp;&nbsp;Está tomando algum medicamento?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-57" name="medic" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-58" name="medic" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>10-&nbsp;&nbsp;Esteve doente ou foi operado nos últimos 5 anos?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-59" name="opera" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-60" name="opera" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>11-&nbsp;&nbsp;Tem hábitos, vícios ou manias?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-61" name="hab" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-62" name="hab" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>12-&nbsp;&nbsp;Tem ansiedade/depressão?<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-63" name="ansi" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-64" name="ansi" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-right: 8px;padding-left: 16px;">
                                    <div class="col"><label class="col-form-label">13-&nbsp;VOCÊ E/OU ALGUM FAMILIAR TEVE ALGUMAS DESSAS DOENÇAS<br></label></div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 26px;">
                                    <div class="col-md-2"><label>Tuberculose<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1" name="tub" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-2" name="tub" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col-md-2"><label>Sarampo<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-3" name="sara" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-4" name="sara" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col-md-2"><label>Sífilis<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-5" name="sifi" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-6" name="sifi" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col"></div>
                                    <div class="col"></div>
                                ...
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 26px;">
                                    <div class="col-md-2"><label>Caxumba<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-7" name="caxu" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-8" name="caxu" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col-md-2"><label>Hepatite A, B, C<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-9" name="hepa" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-10" name="hepa" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col-md-2"><label>Varicela<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-11" name="vari" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-12" name="vari" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                    <div class="col"></div>
                                    <div class="col"></div>
                                ...
                                <div class="form-row" style="padding: 3PX;padding-top: 6px;padding-bottom: 8px;padding-left: 26px;">
                                    <div class="col-md-2"><label>SIDA/AIDS<br></label>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-13" name="aids" value="SIM">
                                            <label class="form-check-label" for="formCheck-1">SIM</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-14" name="aids" value="NÃO">
                                            <label class="form-check-label" for="formCheck-2">NÃO</label></div>
                                    </div>
                                ...
                                <div class="form-row" style="padding: 3PX;padding-top: 10px;padding-bottom: 8px;padding-left: 16px;">
                                    <div class="col"><label>14- É FUMANTE?</label>
                                        ...
                                        <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-16" name="fuma" value="NÃO">
                                            <label class="form-check-label" for="formCheck-40">NÃO</label></div>
                                    </div>
                                </div>
                                <div class="form-row" style="padding: 3PX;padding-top: 3px;padding-right: 8px;padding-left: 16px;">
                                    <div class="col"><input class="form-control form-control-sm" type="text" name="freq" style="width: 200px;" placeholder="Frequência por Dia"></div>
                                </div>
                                <div class="form-row" style="padding: 3px;padding-top: 11px;">
                                    <div class="col"> 
                                        <button  class="btn btn-primary" type="submit" style="filter: sepia(9%);">AVANÇAR</button>
                                    </div>
                                </div>
                            </div>
                        </form>
